...
definitions = {'definitions': {'dentist': {'type': 'object', 'properties': {'id': {'type': 'integer', 'example': 1, 'description': 'dentist id'}, 'name': {'type': 'string', 'example': 'dr.sharon', 'description': 'dentist name'}, 'location': {'type': 'string', 'example': 'Burwood', 'description': 'dentist location'}, 'specialization': {'type': 'string', 'enum': ['Oral Surgery', 'Orthodontics', 'Paediatric Dentistry'], 'example': 'Oral Surgery', 'description': 'dentist specialization'}, 'phone': {'type': 'string', 'example': '0451028117'}}}}, 'parameters': {}}

validators = {
}

filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/dentist'}, 'description': 'a list of all dentists'}}, 404: {'headers': None, 'schema': None}},
    ('dentists_dentistName', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/dentist'}}, 404: {'headers': None, 'schema': None}},
}
